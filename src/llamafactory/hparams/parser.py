...
def get_train_args(args: Optional[Dict[str, Any]] = None) -> _TRAIN_CLS:
    ...
    if finetuning_args.stage != "sft" and finetuning_args.stage != "ttl" and finetuning_args.stage != "ttlr" and finetuning_args.stage != "tent" and finetuning_args.stage != "eata" and finetuning_args.stage != "come" and finetuning_args.stage != "inferenceonly":
