...
from .ttlr import run_ttlr
from .tent import run_tent
from .eata import run_eata
from .come import run_come
from .inferenceonly import run_inferenceonly
...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: List["TrainerCallback"] = []) -> None:
    ...
    elif finetuning_args.stage == "ttlr":
        print("in tuner, running run_ttlr")
        run_ttlr(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    elif finetuning_args.stage == "tent":
        print("in tuner, running run_tent")
        run_tent(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    elif finetuning_args.stage == "eata":
        print("in tuner, running run_eata")
        run_eata(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    elif finetuning_args.stage == "come":
        print("in tuner, running run_come")
        run_come(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    elif finetuning_args.stage == "inferenceonly":
        print("in tuner, running inferenceonly")
        run_inferenceonly(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
