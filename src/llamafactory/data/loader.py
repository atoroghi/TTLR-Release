...
def _get_merged_dataset(
    ...
    data_args: "DataArguments",
    training_args: "Seq2SeqTrainingArguments",
    stage: Literal["pt", "sft", "rm", "ppo", "kto", "ttl", "ttlr"],
    merge: bool = True,
...
def _get_dataset_processor(
    ...
    print("STAGE:", stage)
    print("data_args.packing:", data_args.packing)
    if stage == "pt":
    ...
    elif stage == "ttl" and not do_generate:
        dataset_processor_class = SelfSupervisedDatasetProcessor
    elif stage == "ttlr" and not do_generate:
        dataset_processor_class = SupervisedDatasetProcessor
    elif stage == "rm":
...
def get_dataset(
    ...
    if data_args.tokenized_path is not None:
        print("data_args.tokenized_path", data_args.tokenized_path)
